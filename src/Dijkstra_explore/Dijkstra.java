...
//		System.out.println();
		...
		//System.out.println(distance_min_in_g(g, Q).toString());
	 ...
	 * @param g: le graphe
	 * @param q: tableau des noeuds considere
	 * @return
	 */
	int distance_min_in_g (Graphe g, List<Boolean> q){
		...
		for(int i = 0; i <g.NCases; i++){
			// si le noeud est considere et que sa distance est inferieure a dmin
